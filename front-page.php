    ...
    <section class="contacts-section">
        <div class="container">
            ...
            <div class="contacts-content">
                ...
                <?php if (is_array($contacts_social) && !empty(array_filter($contacts_social))) : ?>
                    <div class="social-links">
                        <h4>Мы в социальных сетях</h4>
                        <div class="social-icons">
                            <?php if (!empty($contacts_social['instagram'])) : ?>
                                <a href="<?php echo esc_url($contacts_social['instagram']); ?>" target="_blank" rel="noopener">
                                    <i class="fab fa-instagram"></i>
                                </a>
                            <?php endif; ?>
                            
                            <?php if (!empty($contacts_social['vk'])) : ?>
                                <a href="<?php echo esc_url($contacts_social['vk']); ?>" target="_blank" rel="noopener">
                                    <i class="fab fa-vk"></i>
                                </a>
                            <?php endif; ?>
                            
                            <?php if (!empty($contacts_social['telegram'])) : ?>
                                <a href="<?php echo esc_url($contacts_social['telegram']); ?>" target="_blank" rel="noopener">
